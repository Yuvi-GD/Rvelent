...
This project is open-source and licensed under the [**MIT License**](LICENSE), giving you full personal and commercial freedom to use, modify, and distribute the engine. See the `LICENSE` file for details.
